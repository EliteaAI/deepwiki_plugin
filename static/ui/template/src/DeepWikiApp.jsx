...
function DeepWikiApp() {
  ...
  // Planner mode (mirrors the wikis Generate dialog): "agent" = DeepAgents
  // structure planner, "cluster" = graph-clustering planner. The cluster
  // planner exposes the optional "smart skip tests" toggle.
  const [plannerMode, setPlannerMode] = useState('agent');
      ...
      >
        ...
        <DialogContent>
          ...
          <Box sx={{ mt: 2.5 }}>
            ...
            >
              <ToggleButton value="agent" aria-label="Agentic planner">
                Agentic
              </ToggleButton>
            ...
            <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mt: 0.75 }}>
              {plannerMode === 'cluster'
                ? 'Builds the wiki outline from code-graph clusters. Faster on large repos.'
                : 'Lets a planner agent draft the outline. Best for small/medium repos with rich docs.'}
            </Typography>
            {plannerMode === 'cluster' && (
              <FormControlLabel
                sx={{ mt: 1 }}
