...
class Relationship:
    ...
    def get_key(self) -> str:
        ...
        return f"{self.source_symbol}->{self.target_symbol}:{self.relationship_type.value}"
...
class BaseParser(ABC):
    ...
    def validate_result(self, result: ParseResult) -> ParseResult:
        ...
        for relationship in result.relationships:
            if (relationship.source_symbol in symbol_names or 
                relationship.target_symbol in symbol_names):
