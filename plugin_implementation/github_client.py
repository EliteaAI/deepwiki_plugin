...
and wiki generation, without dependencies on the full Alita SDK GitHubClient.
...
class StandaloneGitHubClient:
    ...
    Simple Python class that extracts plugin_implementation functionality from Alita SDK's GitHubClient
    ...
    def __init__(self, 
        ...
        if auth is None:
            ...
            self.github_api = Github(base_url=base_url, auth=auth)
    ...
    @classmethod
    def from_url_and_token(cls, 
                          repository_url: str, 
                          access_token: Optional[str] = None,
                          branch: str = "main") -> "StandaloneGitHubClient":
        """
        ...
        while content_queue:
            ...
            if file_content.type == "dir":
                try:
                    ...
                    content_queue.extend(directory_contents if isinstance(directory_contents, list) else [directory_contents])
                except GithubException as e:
    ...
    def get_file_tree(self, max_files: int = 100) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "truncated": len(self.list_all_files()) > max_files
            }
...
def create_github_client(repository_url: str, 
                        access_token: Optional[str] = None,
                        branch: str = "main") -> StandaloneGitHubClient:
    """
